...
class DynamicConfig private constructor(private val mBuilder: Builder) {
    ...
    val isSuffixTimeTextBold: Boolean?
        get() = mBuilder.isSuffixTimeTextBold
    val suffix: String?
        get() = mBuilder.suffix
    ...
    class Builder {
        var timeTextSize: Float? = null
        var timeTextColor: Int? = null
        var isTimeTextBold: Boolean? = null
        var suffixTextSize: Float? = null
        var suffixTextColor: Int? = null
        var suffixGravity: Int? = null
        var isSuffixTimeTextBold: Boolean? = null
        var isShowDay: Boolean? = null
        var isShowHour: Boolean? = null
        var isShowMinute: Boolean? = null
        var isShowSecond: Boolean? = null
        var isShowMillisecond: Boolean? = null
        var isConvertDaysToHours: Boolean? = null
        var backgroundInfo: BackgroundInfo? = null
        var suffix: String? = null
        var suffixDay: String? = null
        var suffixHour: String? = null
        var suffixMinute: String? = null
        var suffixSecond: String? = null
        var suffixMillisecond: String? = null
        var suffixLRMargin: Float? = null
        var suffixDayLeftMargin: Float? = null
        var suffixDayRightMargin: Float? = null
        var suffixSecondLeftMargin: Float? = null
        var suffixSecondRightMargin: Float? = null
        var suffixHourLeftMargin: Float? = null
        var suffixHourRightMargin: Float? = null
        var suffixMinuteLeftMargin: Float? = null
        var suffixMinuteRightMargin: Float? = null
        var suffixMillisecondLeftMargin: Float? = null
